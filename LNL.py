...
def get_neu_and_elec_coord(neu_side_dim,elec_side_dim,grid_side_dim):
    ...
    x_neu_flat = x_neu.reshape((neu_side_dim**2,1))
    y_neu_flat = y_neu.reshape((neu_side_dim**2,1))
    x_elec_flat = x_elec.reshape((elec_side_dim**2,1))
    y_elec_flat = y_elec.reshape((elec_side_dim**2,1))

    return x_neu_flat,y_neu_flat,x_elec_flat,y_elec_flat,x_neu, y_neu, x_elec, y_elec

#==============================================================================================================
# Get the Linear Transform Matrix (L of the LNL model)
#==============================================================================================================
...
#==============================================================================================================
# Initialising the randomised electrical stimulus (NL of the LNL model)
#==============================================================================================================
...
#==============================================================================================================
# Get the Output from the LNL model (NL of the LNL model)
#==============================================================================================================
...
plt.scatter( x_neu, y_neu, c = real_activ_ret_Train[:,0], alpha=0.5, edgecolors=None, cmap = 'gray'  ) 
ax.set_aspect('equal')          
...
plt.scatter( x_neu, y_neu, c = real_activ_ret_Train[:,10], alpha=0.5, edgecolors=None, cmap = 'gray') 
plt.colorbar()    
plt.gca().invert_yaxis()
ax.set_aspect('equal')  
plt.axis('off')
...
plt.scatter( x_neu, y_neu, c = real_activ_ret_Train[:,100], alpha=0.5, edgecolors=None, cmap = 'gray' )     
plt.gca().invert_yaxis()
plt.colorbar()
ax.set_aspect('equal')  
plt.axis('off')
...
class SimpleNeuralNetwork(nn.Module):
    def __init__(self, n_features, m_features):
        ...
        self.linear = nn.Linear(n_features, m_features)
...
model = SimpleNeuralNetwork(64, 256)
print(model)
...
with torch.no_grad():
    ...
    NN_output_test_stims1 = model(test_stims_v_tensor1)
    NN_output_test_stims2 = model(test_stims_v_tensor2)
    NN_output_test_stims3 = model(test_stims_v_tensor3)
