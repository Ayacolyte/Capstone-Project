...
cifar10_train = datasets.CIFAR100(root=cwd+'/data', train=True, download=True,transform=transform)

# Load CIFAR-10 test data
cifar10_test = datasets.CIFAR100(root=cwd+'/data', train=False, download=True,transform=transform)
# ==============================================================================================================================
